  ...
  const handleGoogleLogin = async () => {
    ...
    <div className = "flexbox-container">
      ...
      <form onSubmit={handleSubmit} className = "all-form">
        ...
        <label htmlFor="password2" className = "titulos">Confirmar contraseña </label>
        <br />
        <input
          id="password2"
          name="password2"
        ...
        <br />
        <br />
        <input type="file" className= "docs"/>
        <br />
        <label className= "subtitulos">
        Adjuntar Documentos de validación profesional.
        </label>
        <br />
        ...
        <button type="button"  className= "registro-button"  onClick={handleSubmit}>
          <Link to="./PerfilEsp" >Iniciar</Link>
        </button>
      </form>
    </div>
