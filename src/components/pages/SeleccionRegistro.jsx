...
const SeleccionRegistro = () => {
  return (
    <section className="main-sesion">
      ...
      <Link className="registra-link" to="./RegistroUser">Registrarse como Usuario</Link>
      </div>

      <div className="registra-button">
      <Link className="registra-link" to="./RegistroEsp">Registrarse como Especialista</Link>
      </div>
