        ...
        <div className="todo-user">
          ...
          <div className="relleno">
            ...
            <div className="number-user">
              ...
              <div className="sub">{user.phone? user.phone : <p className="altText">No se especificó número de teléfono</p>}</div>
            </div>
            <div className="line"></div>
            <div className="pais-user">
              <div className="titles">País</div>
              <div className="sub">
                {(user.country)? countries[user.country] : <p className="altText">No se especificó país</p>}
              </div>
            </div>
          </div>
          ...
          <div className="div-button">
            <Link to="./configuracion-especialista" className="register-button">
              EDITAR PERFIL
            </Link>
          </div>
        </div>
